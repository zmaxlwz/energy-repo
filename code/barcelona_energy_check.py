            ...
            if lastDate is None:
                ...
                if lastDailyEnergyConsumption is None:
                    ...
                    if currentDailyEnergyConsumption - lastDailyEnergyConsumption > 0.1:
                        print('{0} {1:.4f} {2:.4f} {3:.4f} {4} {5:6.1f} {6} {7:6.1f}'.format(asset_id, currentDailyEnergyConsumption - lastDailyEnergyConsumption, lastDailyEnergyConsumption, currentDailyEnergyConsumption, lastTime, lastEnergy, currentTime, currentEnergy))
